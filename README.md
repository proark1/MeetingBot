...
**Version 2.8.0** — A stateless meeting bot API service with multi-tenant billing, business account support, Google/Microsoft SSO, Python & JS SDKs, webhook retry/delivery logs, bot persona customization, video recording, Prometheus metrics, idempotency keys, cloud storage, email notifications, calendar auto-join, Slack/Notion integrations, and GDPR compliance.

> **Last updated:** 2026-03-22 · **API version in Swagger UI:** 2.8.0 · **Build:** landing page mode switcher (Teams vs Developers) <!-- auto-updated on each release -->
