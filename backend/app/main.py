...
app = FastAPI(
    ...
    description=(
        ...
        "**Top up via USDC (ERC-20):** `GET /api/v1/billing/usdc/address` — returns the "
        "platform USDC deposit address (configured by admin) or a unique HD-derived address. "
        "Send USDC to that address; 1 USDC = $1 credit, "
