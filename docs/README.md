...
- **OpenAPI snapshot** — [`api/openapi.json`](../api/openapi.json) — 116 public + 135 admin operations, every operation has summary, description, tags, request example, and a 2xx response example
