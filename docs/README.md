...
- **OpenAPI snapshot** — [`api/openapi.json`](../api/openapi.json) — 114 public + 133 admin operations, every operation has summary, description, tags, request example, and a 2xx response example
