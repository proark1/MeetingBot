...
class MeetingBotClient:
    ...
    def cancel_bot(self, bot_id: str) -> Dict[str, Any]:
        ...
        """
        response = self._delete(f"/api/v1/bot/{bot_id}")
    ...
    def delete_webhook(self, webhook_id: str) -> Dict[str, Any]:
        ...
        :returns: Raw JSON response dict.
        """
        response = self._delete(f"/api/v1/webhook/{webhook_id}")
        return response.json()
    ...
    def revoke_api_key(self, key_id: str) -> Dict[str, Any]:
        ...
        :returns: Raw JSON response dict.
        """
        response = self._delete(f"/api/v1/auth/keys/{key_id}")
        return response.json()
    ...
    def delete_keyword_alert(self, alert_id: str) -> Dict[str, Any]:
        """
        ...
        :returns: Raw JSON response dict.
        """
        response = self._delete(f"/api/v1/keyword-alerts/{alert_id}")
        return response.json()
    ...
    def delete_calendar_feed(self, feed_id: str) -> Dict[str, Any]:
        """
        ...
        :returns: Raw JSON response dict.
        """
        response = self._delete(f"/api/v1/calendar/{feed_id}")
        return response.json()
    ...
    def delete_integration(self, integration_id: str) -> Dict[str, Any]:
        ...
        :returns: Raw JSON response dict.
        """
        response = self._delete(f"/api/v1/integrations/{integration_id}")
        return response.json()
    ...
    def delete_workspace(self, workspace_id: str) -> Dict[str, Any]:
        ...
        :returns: Raw JSON response dict.
        """
        response = self._delete(f"/api/v1/workspaces/{workspace_id}")
        return response.json()
    ...
    def remove_workspace_member(self, workspace_id: str, account_id: str) -> Dict[str, Any]:
        """
        ...
        :returns: Raw JSON response dict.
        """
        response = self._delete(f"/api/v1/workspaces/{workspace_id}/members/{account_id}")
        return response.json()
