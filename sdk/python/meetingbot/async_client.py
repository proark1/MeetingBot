...
class AsyncMeetingBotClient:
    ...
    async def export_markdown(self, bot_id: str) -> bytes:
        """
        ...
        """
        response = await self._get(f"/api/v1/bot/{bot_id}/export/markdown")
        return response.content
    ...
    async def get_transcript(self, bot_id: str) -> TranscriptResponse:
        """
        ...
        """
        response = await self._get(f"/api/v1/bot/{bot_id}/transcript")
    ...
    async def analyze_bot(
        ...
        if prompt_override is not None:
            body["prompt_override"] = prompt_override
        response = await self._post(f"/api/v1/bot/{bot_id}/analyze", json=body)
        return AnalysisResponse.model_validate(response.json())

    async def get_highlights(self, bot_id: str) -> HighlightsResponse:
        """
        ...
        """
        response = await self._get(f"/api/v1/bot/{bot_id}/highlight")
        return HighlightsResponse.model_validate(response.json())

    async def ask_bot(self, bot_id: str, question: str) -> AskResponse:
        """
        ...
        :returns: AskResponse
        """
        response = await self._post(f"/api/v1/bot/{bot_id}/ask", json={"question": question})
        return AskResponse.model_validate(response.json())

    async def ask_live_bot(self, bot_id: str, question: str) -> AskResponse:
        """
        ...
        :returns: AskResponse
        """
        response = await self._post(f"/api/v1/bot/{bot_id}/ask-live", json={"question": question})
        return AskResponse.model_validate(response.json())
    ...
    async def generate_followup_email(
        ...
        if tone is not None:
            body["tone"] = tone
        response = await self._post(f"/api/v1/bot/{bot_id}/followup-email", json=body)
        return FollowupEmailResponse.model_validate(response.json())

    async def rename_speakers(self, bot_id: str, mapping: Dict[str, str]) -> Dict[str, Any]:
        """
        ...
        :returns: Raw JSON response dict.
        """
        response = await self._patch(f"/api/v1/bot/{bot_id}/speakers", json={"mapping": mapping})
        return response.json()

    async def share_bot(self, bot_id: str) -> ShareResponse:
        """
        ...
        """
        response = await self._post(f"/api/v1/bot/{bot_id}/share", json={})
    ...
    async def list_webhook_events(self) -> WebhookEventsResponse:
        """
        List all supported webhook event types.

        :returns: WebhookEventsResponse
        """
        response = await self._get("/api/v1/webhook/events")
    ...
    async def test_webhook(self, webhook_id: str) -> Dict[str, Any]:
        ...
        :returns: Raw JSON response dict.
        """
        response = await self._post(f"/api/v1/webhook/{webhook_id}/test", json={})
        return response.json()
    ...
    async def list_all_deliveries(
        ...
        if offset is not None:
            params["offset"] = offset
        response = await self._get("/api/v1/webhook/deliveries", params=params)
        return WebhookDeliveryListResponse.model_validate(response.json())
    ...
    async def get_me(self) -> AccountInfo:
        ...
        :returns: AccountInfo
        """
        response = await self._get("/api/v1/auth/me")
        return AccountInfo.model_validate(response.json())

    async def list_test_keys(self) -> ApiKeyListResponse:
        """
        List all test (sandbox) API keys.

        :returns: ApiKeyListResponse
        """
        response = await self._get("/api/v1/auth/test-keys")
        return ApiKeyListResponse.model_validate(response.json())

    async def create_test_key(self, name: str) -> ApiKeyCreateResponse:
        """
        ...
        """
        response = await self._post("/api/v1/auth/test-keys", json={"name": name})
        return ApiKeyCreateResponse.model_validate(response.json())
    ...
    async def delete_account(self) -> Dict[str, Any]:
        ...
        :returns: Raw JSON response dict.
        """
        response = await self._delete("/api/v1/auth/account")
        return response.json()

    async def update_account_type(self, account_type: str) -> Dict[str, Any]:
        """
        ...
        :returns: Raw JSON response dict.
        """
        response = await self._put("/api/v1/auth/account-type", json={"account_type": account_type})
        return response.json()
    ...
    async def list_templates(self) -> TemplateListResponse:
        ...
        """
        response = await self._get("/api/v1/templates")
        return TemplateListResponse.model_validate(response.json())

    async def get_default_prompt(self) -> DefaultPromptResponse:
        """
        Get the default analysis prompt.

        :returns: DefaultPromptResponse
        """
        response = await self._get("/api/v1/templates/default-prompt")
    ...
    async def get_analytics(self) -> AnalyticsResponse:
        ...
        """
        response = await self._get("/api/v1/analytics")
    ...
    async def get_recurring_analytics(
        ...
        response = await self._get("/api/v1/analytics/recurring", params=params)
        return RecurringAnalyticsResponse.model_validate(response.json())

    async def get_api_usage(self) -> ApiUsageResponse:
        """
        Get API usage statistics.

        :returns: ApiUsageResponse
        """
        response = await self._get("/api/v1/analytics/api-usage")
        return ApiUsageResponse.model_validate(response.json())

    async def get_my_analytics(self) -> MyAnalyticsResponse:
        """
    ...
    async def search_meetings(
        ...
        if offset is not None:
            params["offset"] = offset
        response = await self._get("/api/v1/search", params=params)
    ...
    async def get_audit_log(
        ...
        if offset is not None:
            params["offset"] = offset
        response = await self._get("/api/v1/audit-log", params=params)
    ...
    async def list_action_items(
        ...
        if offset is not None:
            params["offset"] = offset
        response = await self._get("/api/v1/action-items", params=params)
    ...
    async def update_action_item(
        ...
        response = await self._patch(f"/api/v1/action-items/{item_id}", json=body)
    ...
    async def list_keyword_alerts(self) -> KeywordAlertListResponse:
        """
        List all keyword alerts.

        :returns: KeywordAlertListResponse
        """
        response = await self._get("/api/v1/keyword-alerts")
    ...
    async def create_keyword_alert(
        ...
        if events is not None:
            body["events"] = events
        response = await self._post("/api/v1/keyword-alerts", json=body)
        return KeywordAlertResponse.model_validate(response.json())

    async def get_keyword_alert(self, alert_id: str) -> KeywordAlertResponse:
        """
        ...
        :returns: KeywordAlertResponse
        """
        response = await self._get(f"/api/v1/keyword-alerts/{alert_id}")
        return KeywordAlertResponse.model_validate(response.json())
    ...
    async def list_calendar_feeds(self) -> CalendarFeedListResponse:
        """
        List all calendar feeds.

        :returns: CalendarFeedListResponse
        """
        response = await self._get("/api/v1/calendar")
    ...
    async def sync_calendar_feed(self, feed_id: str) -> Dict[str, Any]:
        ...
        :returns: Raw JSON response dict.
        """
        response = await self._post(f"/api/v1/calendar/{feed_id}/sync", json={})
        return response.json()
    ...
    async def list_integrations(self) -> IntegrationListResponse:
        ...
        """
        response = await self._get("/api/v1/integrations")
    ...
    async def create_integration(
        ...
        response = await self._post("/api/v1/integrations", json=body)
    ...
    async def list_workspaces(self) -> WorkspaceListResponse:
        ...
        """
        response = await self._get("/api/v1/workspaces")
    ...
    async def create_workspace(self, name: str) -> WorkspaceResponse:
        ...
        """
        response = await self._post("/api/v1/workspaces", json={"name": name})
    ...
    async def get_workspace(self, workspace_id: str) -> WorkspaceResponse:
        ...
        :returns: WorkspaceResponse
        """
        response = await self._get(f"/api/v1/workspaces/{workspace_id}")
        return WorkspaceResponse.model_validate(response.json())
    ...
    async def list_workspace_members(self, workspace_id: str) -> WorkspaceMemberListResponse:
        ...
        """
        response = await self._get(f"/api/v1/workspaces/{workspace_id}/members")
    ...
    async def get_retention_policy(self) -> RetentionPolicyResponse:
        ...
        """
        response = await self._get("/api/v1/retention")
    ...
    async def update_retention_policy(
        ...
        response = await self._put("/api/v1/retention", json=body)
        return RetentionPolicyResponse.model_validate(response.json())
    ...
    async def get_mcp_schema(self) -> McpSchemaResponse:
        ...
        """
        response = await self._get("/api/v1/mcp/schema")
    ...
    async def call_mcp_tool(
        ...
        response = await self._post("/api/v1/mcp/call", json=body)
